...
10.  Troubleshoot data transformers
    ...
    1. normalise (data standardiasation) and denormalise
    ...
    2.  Perform EDA - synapse spark pool - right click and load to dataframe, adf has data preview
...
24.  Tune data storage
     ...
     4.  handle spill data - might not hold all data in memory and spills to disk
       ...
       1.  Tume shuffle partitions - spark shuffles data between nodes - might be preferable to reduce this (to improve trouble shooting e.g)
     5.  find shuffle in a pipeline - synapse sql and spark have EXPLAIN statements that explain query execution plans
     6.  optimise resource management - cost optimiseation, pause synapse pools (not billed when deallocated)
     7.  ps - VMs have bidding mechanisms, stateless ephemeral VMs can be obtained for a high discount, with the downside of being stopped/deallocated if a higher bidder appears
